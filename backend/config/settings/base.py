"""Settings common to every environment. dev.py / prod.py import from here."""
...
# SECRET_KEY and DEBUG are set per-environment in dev.py / prod.py.
...
# JWTs live in httpOnly cookies (never in JS/localStorage). The Secure flag is
# set per-environment; SameSite=Lax works for same-site localhost dev.
